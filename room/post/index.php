...
<body>
    ...
    <form>
            ...
            <div class="info">
                ...
                <div class="info-1">
                    <div class="localisation">
                        ...
                        <h4 class="sub-info">FRANCE, Paris, 1 Rue De Paris </h4>
                    </div>
                    <div class="notation">
        ...
        <section class="descrition">
            ...
            <div class="owner">
                <h3>Hotel</h3>
                <select name="hotel" class="info-desc input-add input-room">
                    <option selected="selected" disabled>Hotel of the room</option>
                </select>
            </div>
            <div class="owner">
                <h3>Ded</h3>
                <input name="place" class="input-add bed-input" type="number" required min="0" />
            </div>
        </section>
        <section id="room-reservation" width="90% !important">
            <div class="room-one-night">
                <input class="input-add" name="price" placeholder="Prix" type="number" step="0.01" min="0" required />
                <h4>$</h4>
                <h5>/night</h5>
            </div>
            <select class="info-desc input-add input-room chose-room-type" name="type" required>
                <option value="SOLO">Private Room</option>
                <option value="DORTORY">Dortory</option>
            </select>
            <div class="contain-date">
                <input class="input-add input-date-until" name="dto" placeholder="Until" type="date" required />
                <h4>Until</h4>
            </div>
